...
for (let i =0; i < elementos.length; i++){
    ...
    tagCriada.innerHTML = texto;    // Qual é melhor? innerHTML ou createTextNode? innerHTML é mais rápido, mas createTextNode é mais seguro. innerHTML pode ser usado para inserir HTML, enquanto createTextNode só pode ser usado para inserir texto.
